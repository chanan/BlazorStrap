...
namespace BlazorStrap
{
    ...
    public class BSInput<T> : BSInputBase<T>
    {
        ...
        private string? ClassBuilder => new CssBuilder()
            ...
            .AddClass($"form-control-{InputSize.ToDescriptionString()}", InputType != InputType.Select && InputSize != Size.None)
            .AddClass($"form-select-{InputSize.ToDescriptionString()}", InputType == InputType.Select && InputSize != Size.None)
