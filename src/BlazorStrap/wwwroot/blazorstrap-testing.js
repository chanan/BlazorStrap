...
window.blazorStrap = {
    ...
    AddDocumentEvent: async function(id, name, type, ignoreChildren = false, filter = "")
    {
        return new Promise(function (resolve) {
            blazorStrap.AddEventInternal(document, id,name,type,ignoreChildren, filter);
            resolve();
        });
    },
    AddEventInternal: function(element, id, name, type, ignoreChildren = false, filter = "")
    {
    ...
    AddEvent: async function (id, name, type, isDocument = false, ignoreChildren = false, filter = "") {
        return new Promise(function (resolve) {
            blazorStrap.AddEventInternal(document.querySelector("[data-blazorstrap='" + id + "']"), id,name,type,ignoreChildren, filter);
            resolve();
        });
    },
    ...
    AnimateCollapse: async function (element, id, shown, name, type) {
        if (shown) {
