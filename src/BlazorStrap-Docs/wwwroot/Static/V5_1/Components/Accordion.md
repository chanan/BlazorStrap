...
{{sample=V5_1/Components/Accordion/Accordion1}}

### Flush

{{sample=V5_1/Components/Accordion/Accordion2}}

### Always open & default shown

{{sample=V5_1/Components/Accordion/Accordion3}}

### Default shown false first item

{{sample=V5_1/Components/Accordion/Accordion4}}
