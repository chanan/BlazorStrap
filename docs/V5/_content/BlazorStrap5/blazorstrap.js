...
window.blazorStrap = {
                ...
                [type]: {
                    Callback: function (event) {
                        ...
                        if (filter === "") {
                            ...
                            DotNet.invokeMethodAsync("BlazorStrap5", "EventCallback", id, name, type, element.classList, blazorStrap.GetEvents(event));
    ...
    RemoveEvent: async function (id, name, type, isDocument = false) {
        return new Promise(function (resolve) {
            //Me being lazy fix issue caused by event listener already being removed else where
...
window.addEventListener("resize", function () {
    ...
    ResizeFunc = setTimeout(function () {
        // noinspection JSUnresolvedVariable,JSUnresolvedFunction
        DotNet.invokeMethodAsync("BlazorStrap5", "ResizeComplete", document.documentElement.clientWidth);
    }, 500);
});
